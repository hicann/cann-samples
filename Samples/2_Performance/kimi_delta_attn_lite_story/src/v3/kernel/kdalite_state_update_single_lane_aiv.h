...
// state 副本, R 和 stateDecay 通过 Mutex 与 MTE2/MTE3 交接; O 由 AIC Fixpipe 直接写 GM.
...
constexpr uint32_t STATE_AIV_UB_END_ADDR = STATE_DECAY_UB_ADDR + HEAD_DIM * sizeof(float) * DB_SLOT_NUM;
