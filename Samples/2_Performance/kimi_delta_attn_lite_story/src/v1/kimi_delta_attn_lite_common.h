...
#ifndef KDALITE_V1_CHUNK_SIZE
#define KDALITE_V1_CHUNK_SIZE 32
#endif
constexpr uint32_t CHUNK_SIZE = KDALITE_V1_CHUNK_SIZE;
constexpr uint32_t DV_TILE = 32;
constexpr uint32_t AIV_DV_TILE = 16;

static_assert(
    CHUNK_SIZE >= 16 && CHUNK_SIZE <= 64 && (CHUNK_SIZE & (CHUNK_SIZE - 1)) == 0,
    "v1 CHUNK_SIZE must be 16, 32, or 64");
