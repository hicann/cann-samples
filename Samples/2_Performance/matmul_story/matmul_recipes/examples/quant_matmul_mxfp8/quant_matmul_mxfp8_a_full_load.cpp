...
__global__ __aicore__ __cube__ void QuantMatmulMxfp8AFullLoadKernel(
...
int main(int argc, char* argv[])
{
    ...
    try {
        ...
        QuantMatmulTilingAFullLoad<mm::DataType::DT_FLOAT8_E4M3FN, mm::DataType::DT_FLOAT8_E4M3FN> tilingEngine;
