...
/** In `BlockShape`, offsets within M/N sub-tiles (non-zero for last-round tile splitting in Step 3 / Step 4; 0 otherwise). */
...
/** MMAD / FIXPIPE UnitFlag: final accumulation vs intermediate accumulation along K
 *  (consistent with CANN AscendC conventions; see `Step 4` `block_mmad_mx`). */
