...
public:
    ...
    int64_t mCoreNum_{0};   // rows per group (baseM tiles)
    int64_t mTailCoreNum_{0};
    int64_t mainRow_{0};    // index of last full row group
...
public:
    ...
    // Group by baseM rows, column-major; even row groups L->R, odd R->L
