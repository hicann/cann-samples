...
AscendC::Te::Mmad(
        ...
        BlockShape singleShape)
    {
        ...
        for (uint64_t iter0 = 0; iter0 < kL1Iter_; ++iter0) {
            ...
            if (abL1LoopCnt_ == 0) {
                auto CopyScaleGM2L1 = AscendC::Te::MakeCopy(AscendC::Te::CopyGM2L1{});
                auto gmBlockScaleA = gmScaleA.Slice(AscendC::Te::MakeCoord(0, 0),
                    AscendC::Te::MakeShape(
                        curM, CeilDiv(k_, MXFP_DIVISOR_SIZE_LOCAL) * MXFP_MULTI_BASE_SIZE_LOCAL));
            ...
            auto tensorBlockAL1 = tensorAL1.Slice(AscendC::Te::MakeCoord(0, kL1Offset), AscendC::Te::MakeShape(curM, curGmAKL1));
            ...
            auto tensorBlockScaleAL1 = tensorScaleAL1.Slice(AscendC::Te::MakeCoord(
