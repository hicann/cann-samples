...
public:
        ...
        TensorL0C& tensorL0C)
    {
        ...
        for (uint16_t iter1 = 0; iter1 < kL0Iter; ++iter1) {
            ...
            auto tensorBlockAL1Slice = tensorBlockAL1.Slice(AscendC::Te::MakeCoord(0, kL0Offset), AscendC::Te::MakeShape(curM, curKL0));
            AscendC::Te::Copy(CopyL12L0A, tensorAL0, tensorBlockAL1Slice);

            auto layoutScaleAL0 = AscendC::Te::MakeFrameLayout<AscendC::Te::ZZLayoutPtn, AscendC::Std::Int<SCALE_C0>>(curM, curScaleKL0);
            ...
            CopyL12L0MxScaleA.Call(tensorScaleAL0, tensorBlockScaleAL1, AscendC::Te::MakeCoord(0, scaleKL1IterOffset + kL0Offset));
            ...
            auto tensorBlockBL1Slice = tensorBL1.Slice(AscendC::Te::MakeCoord(kL0Offset, 0), AscendC::Te::MakeShape(curKL0, curN));
            AscendC::Te::Copy(CopyL12L0B, tensorBL0, tensorBlockBL1Slice);

            auto layoutScaleBL0 = AscendC::Te::MakeFrameLayout<AscendC::Te::NNLayoutPtn, AscendC::Std::Int<SCALE_C0>>(curScaleKL0, curN);
            ...
            CopyL12L0MxScaleB.Call(tensorScaleBL0, tensorBlockScaleBL1, AscendC::Te::MakeCoord(scaleKL1IterOffset + kL0Offset, 0));
        ...
        for (uint64_t iter0 = 0; iter0 < kL1Iter_; ++iter0) {
            ...
            if (iter0 % scaleKL1Ratio_ == 0) {
                ...
                auto tensorScaleAL1Buf = AscendC::Te::MakeTensor(
                    ...
                    layoutScaleAL1);
                auto gmBlockScaleA = gmScaleA.Slice(AscendC::Te::MakeCoord(0, scaleKL1Offset / MXFP_GROUP_SIZE_LOCAL),
                ...
                auto tensorScaleBL1Buf = AscendC::Te::MakeTensor(
                    ...
                    layoutScaleBL1);
                auto gmBlockScaleB = gmScaleB.Slice(AscendC::Te::MakeCoord(scaleKL1Offset / MXFP_GROUP_SIZE_LOCAL, 0),
                    AscendC::Te::MakeShape(
            ...
            auto tensorAL1Iter = AscendC::Te::MakeTensor(
                AscendC::Te::MakeMemPtr<AscendC::Te::Location::L1, AType>(l1BufferAOffset_[l1BufId]), layoutAL1Iter);
            ...
            auto layoutScaleAL1ForL0 = AscendC::Te::MakeFrameLayout<AscendC::Te::ZZLayoutPtn, AscendC::Std::Int<SCALE_C0>>(
                curM, CeilDiv(scaleKL1_, MXFP_DIVISOR_SIZE_LOCAL) * MXFP_MULTI_BASE_SIZE_LOCAL);
            auto tensorBlockScaleAL1 = AscendC::Te::MakeTensor(
                AscendC::Te::MakeMemPtr<AscendC::Te::Location::L1, fp8_e8m0_t>(l1BufferScaleAOffset_[scaleL1BufId]),
                layoutScaleAL1ForL0);

            auto layoutScaleBL1ForL0 = AscendC::Te::MakeFrameLayout<AscendC::Te::NNLayoutPtn, AscendC::Std::Int<SCALE_C0>>(
