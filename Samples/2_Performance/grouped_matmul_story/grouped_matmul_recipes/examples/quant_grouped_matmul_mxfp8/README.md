...
- `quant_grouped_matmul_mxfp8`：基于m轴分组、权重按ND（包括**NDExtLayout/DNExtLayout**，下面仅用ND统称）逻辑组织的分组量化矩阵乘示例。
...
- 当`transB=true`时，A的形状为`[M, K]`，B ND/NZ的形状为`[E, N, K]`/`[E, K1, N1, N0, K0]`，N0=16，K0=32，N1=ceil(N/N0)，K1=ceil(K/K0)。
- 当`transB=false`时，A的形状为`[M, K]`，B ND/NZ的形状为`[E, K, N]`/`[E, N1, K1, K0, N0]`,K0=16,N0=32,K1=ceil(K/K0)，N1=ceil(N/N0)。
- 当前仅支持m轴分组。
