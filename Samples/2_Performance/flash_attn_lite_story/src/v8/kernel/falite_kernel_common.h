...
#endif
// S 和 oDelta 的同一 FlagID 在 ready/free 两个方向交替传递槽所有权.
constexpr uint16_t FLAG_S_HANDOFF_BASE = 0;
constexpr uint16_t FLAG_P_READY_BASE = FLAG_S_HANDOFF_BASE + DB_SLOT_NUM;
constexpr uint16_t FLAG_O_DELTA_HANDOFF_BASE = FLAG_P_READY_BASE + CV_PIPELINE_SLOT_NUM;
