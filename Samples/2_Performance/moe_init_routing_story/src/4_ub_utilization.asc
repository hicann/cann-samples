...
public:
                                ...
                                MoeInitRoutingTilingData *tilingData, TPipe *tPipe)
    {
        ...
        pipe_->InitBuffer(xCopyInQueue_, DOUBLE_BUFFER, 
                          curCorePerLoopIndicesElements_ * AlignBytes(perLoopCols_, sizeof(float)));
        pipe_->InitBuffer(scaleCopyInQueue_, DOUBLE_BUFFER, 
                          curCorePerLoopIndicesElements_ * AlignBytes(1, sizeof(float)));
                                   ...
                                   LocalTensor<float> xLocal)
    {
        ...
        DataCopyPad(xLocal[xLocalOffset], xGm_[xSrcOffset], copyParams, padParams);
    ...
    __aicore__ inline void Process()
    {
        ...
        for (int64_t indicesLoop = 0; indicesLoop < indicesLoops_; indicesLoop++) {
            ...
            for (int64_t indicesIndex = 0; indicesIndex < curLoopElements; indicesIndex++) {
                ...
                int64_t xLocalOffset = indicesIndex * cols_;
