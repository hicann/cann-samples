...
cp ./Samples/1_Features/instruction_optimization/unit_flag/scripts/* ./build/Samples/1_Features/instruction_optimization/unit_flag/
...
[verify] shape(1024, 4096), elements=4194304 - summary (large matrix, full tensors omitted)
  abs_err: max=2.560000e+02, mean=7.385254e-03, rmse=1.375000e+00
  rel_err: max=6.410256e-03
  count(|abs_err| > 0.001): 121 / 4194304
  cpu golden (top-left 4x4):
tensor([[42496., 42496., 41728., 41728.],
        [41728., 41984., 41216., 40960.],
        [41984., 41984., 41216., 41216.],
        [41216., 41472., 40960., 40960.]], dtype=torch.bfloat16)
...
ratio error count(>0.001): 121/4194304, error ratio: 0.000029
