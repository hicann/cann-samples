 ...
 * \brief
 */
#ifndef IMPL_TENSOR_API_ARCH_CUBE_DATAMOVE_FIXPIPE_NPU_ARCH_3510_FIXPIPE_QUANT_L0C2UB_NZ2ND_H
#define IMPL_TENSOR_API_ARCH_CUBE_DATAMOVE_FIXPIPE_NPU_ARCH_3510_FIXPIPE_QUANT_L0C2UB_NZ2ND_H
...
class Fixpipe2UbNZ2NDSimpleQuant3510 {
public:
...
class Fixpipe2UbNZ2NDVectorBase3510 {
public:
    template <const FixpipeTrait& trait, QuantMode_t quantPre, typename T, typename U, typename V, typename... Params>
...
class Fixpipe2UbNZ2NDVectorQuant3510 : public Fixpipe2UbNZ2NDVectorBase3510 {
public:
    template <const FixpipeTrait& trait, QuantMode_t quantPre, typename T, typename U, typename V, typename Params>
    __aicore__ inline void Run(const T& dst, const U& src, const V& quant, const Params& params)
    {
...
#endif  // IMPL_TENSOR_API_ARCH_CUBE_DATAMOVE_FIXPIPE_NPU_ARCH_3510_FIXPIPE_QUANT_L0C2UB_NZ2ND_H
