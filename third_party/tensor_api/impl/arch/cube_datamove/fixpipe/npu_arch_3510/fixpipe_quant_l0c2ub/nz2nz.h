 ...
 * \brief
 */
#ifndef IMPL_TENSOR_API_ARCH_CUBE_DATAMOVE_FIXPIPE_NPU_ARCH_3510_FIXPIPE_QUANT_L0C2UB_NZ2NZ_H
#define IMPL_TENSOR_API_ARCH_CUBE_DATAMOVE_FIXPIPE_NPU_ARCH_3510_FIXPIPE_QUANT_L0C2UB_NZ2NZ_H
...
class Fixpipe2UbNZ2NZSimpleQuant3510 {
public:
...
class Fixpipe2UbNZ2NZVectorBase3510 {
public:
    ...
    {
        FixpipeNZ2NZVectorCompute<trait, quantPre, T, U, V>(dst, src, quant, params...);
    }
...
class Fixpipe2UbNZ2NZVectorQuant3510 : public Fixpipe2UbNZ2NZVectorBase3510 {
public:
    template <const FixpipeTrait& trait, QuantMode_t quantPre, typename T, typename U, typename V, typename Params>
...
private:
    ...
    __aicore__ inline void DataCopyImpl(const T& dst, const U& src, const V& quant, const Params& params)
    {
        ...
        FixpipeNZ2NZVectorEntrance<trait, quantPre, T, U, V>(dst, src, quant, nIterNum, calNSize, tailNSize, params);
    }
};
...
#endif  // IMPL_TENSOR_API_ARCH_CUBE_DATAMOVE_FIXPIPE_NPU_ARCH_3510_FIXPIPE_QUANT_L0C2UB_NZ2NZ_H
